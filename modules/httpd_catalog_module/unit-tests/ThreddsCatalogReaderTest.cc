...
#define prolog std::string("ThreddsCatalogReaderTest::").append(__func__).append("() - ")


namespace httpd_catalog {

class ThreddsCatalogReaderTest: public CppUnit::TestFixture {
private:
...
CPPUNIT_TEST_SUITE_REGISTRATION(ThreddsCatalogReaderTest);
...
int main(int argc, char*argv[])
{
    ...
    if (i == argc) {
        ...
        while (i < argc) {
            ...
            test = httpd_catalog::ThreddsCatalogReaderTest::suite()->getName().append("::").append(argv[i]);
